...
Authoring component for the **Table** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-table-edit
```
...
```ts
import { Edit } from '@tailor-cms/ce-table-edit';
```
